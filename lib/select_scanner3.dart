...
class SelectScanner3 extends StatefulWidget {
  @override
  _SelectScanner3State createState() {
    return _SelectScanner3State();
  }
}

class _SelectScanner3State extends State<SelectScanner3> {
