...
class SelectScanner2 extends StatefulWidget {
  @override
  _SelectScanner2State createState() {
    return _SelectScanner2State();
  }
}

class _SelectScanner2State extends State<SelectScanner2> {
  ...
  String _selectedScanner = BARCODE_SCANNER;
